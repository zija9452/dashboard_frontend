...
const WarehouseDuplicateBillPage: React.FC = () => {
  ...
  const [billType, setBillType] = useState<string>('WAREHOUSE DUPLICATE BILL');
  ...
  const handlePrintInvoice = async (invoice: Invoice) => {
    try {
      ...
      setBillType('WAREHOUSE DUPLICATE BILL');
  ...
  return (
    <div className="p-2 py-5 bg-white min-h-screen">
      <PageHeader title="Warehouse Duplicate Bill" />
            ...
            {totalItems > 0 && (
              <div className="mt-4">
                <Pagination
                  ...
                  pageSize={pageSize}
                  baseUrl="/warehouse-duplicate-bill"
...
export default WarehouseDuplicateBillPage;
