  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingUser) {
        ...
        const validRoles = ['admin', 'cashier', 'employee', 'warehouse', 'order_booker', 'production', 'sales'];
  ...
  return (
    <div className="p-2 py-5">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-6">
        {/* Add New button - mobile pe upar, desktop pe left */}
        <button
          onClick={() => {
            resetForm();
        ...
        {/* Search bar - mobile pe niche, desktop pe right */}
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {adminUsers.map((user) => (
                  <tr key={user.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{user.cnic || '-'}</td>
