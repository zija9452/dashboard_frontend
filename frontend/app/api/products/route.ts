...
export async function GET(request: NextRequest) {
  try {
    ...
    const backendUrl = `${process.env.NEXT_PUBLIC_API_BASE_URL || 'http://localhost:8000'}/products/viewproduct?page=${page}&limit=${limit}&search_string=${searchString}&branches=${branches}`;
