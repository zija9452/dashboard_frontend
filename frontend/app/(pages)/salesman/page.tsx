...
const SalesmanPage: React.FC = () => {
  ...
  const [deletingId, setDeletingId] = useState<string | null>(null); // Track which salesman is being deleted
                    ...
                    <td className="px-4 py-4 whitespace-nowrap">
                      <div className="flex gap-2">
                        <button
                          ...
                          disabled={deletingId === salesman.sal_id}
                          className={`${
                            deletingId === salesman.sal_id
